...
#def init_adxl345():
    #bus.write_byte_data(DEVICE_ADRESS, POWER_CTL, 0x08)
    
#def read_acceleration():
   # data = bus.read_i2c_block_data(DEVICE_ADRESS, DATAX0, 4)
    #x = ((data[1] << 8) | data[0]) & 0x3FF
    #y = ((data[3] << 8) | data[2]) & 0x3FF
    #return y, x
...
def affichage_elements(m, hp,check, frame_count):
    ...
    pygame.draw.rect(SCREEN, (255,255,255), pygame.Rect(380,720,2.5,120))
    pygame.draw.rect(SCREEN, (255,255,255), pygame.Rect(180,720,2.5,120))
    pygame.draw.rect(SCREEN, (255,255,255), pygame.Rect(180,720,2.5,120))
...
def main(frame_count):
    ...
    while running:
        ...
        if 60 < frame_count < 90:
            SCREEN.blit((police.render('3', False, (0,0,0))), (750,450))
        if 90 < frame_count < 120:
            SCREEN.blit((police.render('2', False, (0,0,0))), (750,450))
        if 120 < frame_count < 150:
            SCREEN.blit((police.render('1', False, (0,0,0))), (750,450))
        if 150 < frame_count < 250:
            SCREEN.blit((police.render('GO', False, (0,0,0))), (750,450))
            start = True
